...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="home/favicon-32x32.png" sizes="32x32" />
        <link rel="icon" type="image/png" href="home/favicon-16x16.png" sizes="16x16" />
    ...
    <body>
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-3 col-sm-3">
                                                                <a style="padding-top:0px;" class="navbar-brand navBrandText text-uppercase font-weight-bold" href="Uhome.html"><img src="home/img/logo/cemrebakerylogo.png" alt="restorant" /></a>
                                                                
                                                            </div>
                                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                                <a href="Uhome.html"><img class="img-responsive logo" src="home/img/logo/cemrebakerytextlogolight.png" alt="restorant" /></a>
        ...
        <section id="section0" class="slider-area"> 
            <div class="main-slider owl-theme owl-carousel"> 
                <!-- Start Slingle Slide -->
                <div class="single-slide item" style="background-image: url(home/img/slider/1900x1000.png)">
                                ...
                                <div class="row">
                                        <div class="slide-content-wrapper text-center">
                                            <div class="slide-content">
                                                <img class="classic" src="home/img/logo/cemrebakerylogo.png">
                                                <h3>BAKERY MAKES </h3>
                                                ...
                                                <img class="classic" src="home/img/new/icon.png">
                ...
                <div class="single-slide item" style="background-image: url(home/img/slider/wepik--2022523-173619.jpeg)">
            ...
            <div class="container">
                ...
                <div class="row shapes">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 minHeightProp">
                                <img class="imgback" src="home/img/shape/shape1.png">
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 minHeightProp">
                                <img class="imgback" src="home/img/shape/shape2.png">
                            </div>
                            <div class="col-md-12">
                                <div class="text-center">
                                    <span>Serve You Since 1988</span>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 minHeightProp">
                                <img class="imgback" src="home/img/shape/shape3.png">
                            </div>
                            <div class="col-md-12">
                                <div class="text-center">
                                    <span>Serve You Since 1988</span>
        ...
        <div class="container">
            <div class="banner"
            style="background-image: url('home/img/new/1170x268.png');">
                            ...
                            <div id="news-slider" class="news-slider owl-theme owl-carousel">
                                <div class="post-slide">
                                    <div class="post-img">
                                        ...
                                        <img src="home/img/new/productnew.png" alt="">
                                    </div>
        ...
        <section id="section4" class="parallax-window" data-parallax="scroll" data-image-src="home/img/slider/1900x1000.png">
            <h3>What We Say</h3>
        ...
        <script src="home/js/jquery-easing/jquery.easing.min.js"></script>
