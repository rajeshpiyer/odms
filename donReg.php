...
<style>
  body {
			background-image:url("img/photo/ok.jpg");
...
if(empty($mt6))
{
$errt6="Number is blank";
$temp=1;
}
if(empty($mt7))
{
$errt7="password is blank";
$temp=1;
}
if ($temp==0)
{
//$n=mysql_query("insert into register ( nam ,cperson, mobile, email,status) values('$mt1','$mt2','$mt3','$mt4','N')");
$n=$obj1->InsertUpdateDelete("insert into donor ( name, blood, age, gender, email, num, pass, type) values('$mt1','$mt2','$mt3','$mt4','$mt5','$mt6','$mt7','DN')");
$m=$obj1->InsertUpdateDelete("insert into user ( email, pass, type) values('$mt5','$mt7','DN')");
if($n>0)
...
<body>
    <form name="form1" method="post" action="">
        ...
        <div class="panel-heading">
            <h3 class="panel-title" style="color: antiquewhite"><span class="fa fa-pencil-square-o">DONOR REGESTRATION </span> </h3>
            </div>
            </div>
            <br>
        <div>
            <table border="0">
              ...
              <tr> 
                <td>BLOOD GROUP</td>
               <td> <select name="t2" id="subject" required>
    ...
    <option  value="AB+">AB+</option>
              ...
              <tr> 
                <td>AGE</td>
                <td><input name="t3" type="text" size="70" required minlength="2" maxlength="2" required pattern="[0-9]+" title= "Use digits only" value="<?php if(isset($mt3)) echo $mt3; ?>"></td>
              ...
              <tr> 
                <td>PHONE NUMBER</td>
                <td><input name="t6" type="text" size="70" pattern="[0-9]+" required minlength="10" maxlength="10" title="use proper 10 digit mobile number" value="<?php if(isset($mt6)) echo $mt6; ?>"></td>
                <td><?php echo $errt6; ?></td>
              </tr>
              <tr>
                <td >password</td>
                <td><input name="t7" type="password" required pattern="[^' ']+" title="No spaces" value="<?php if(isset($mt7)) echo $mt7; ?>" size="70"></td>
                <td><?php echo $errt7; ?></td>
              </tr>
              <tr> 
                <td></td>
                </tr>
