...
include_once("ex.php");
$obj=new ex;
$don=$obj->UniqueRecords("select * from hospital where email='$email'");
...
$s="update hospital set name='$mt1', address='$mt2', email='$mt4', phone='$mt3' where email='$email'";
...
<div class="container bootstrap snippets bootdey">
    <h1 style="color: white" class="text-primary">EDIT DETAILS</h1>
    <p> &nbsp</p>
      <hr>
	<div class="row">
      <!-- left column -->
      ...
      <div class="col-md-9 personal-info">
        <div class="alert alert-info alert-dismissable">
          ...
          <i ></i>
          Edit the hospital<strong> contact</strong> details
        </div>
        <p> &nbsp</p>
        <form class="form-horizontal" role="form" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="t2" value="<?php  echo $don[2];?> "required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="t4" value="<?php  echo $don[4];?>"required >
            </div>
          </div>
